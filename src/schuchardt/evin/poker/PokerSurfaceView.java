...
public class PokerSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
	class PokerThread extends Thread {
        /*
         * Member (state) fields
         */
        ...
        public PokerThread(SurfaceHolder surfaceHolder, Context context,
                Handler handler) {
...
//        }
	...
	public PokerSurfaceView(Context context) {
		super(context);
        ...
        thread = new PokerThread(holder, context, new Handler() {
            @Override
